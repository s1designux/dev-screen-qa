...
사건: 등록 · 승인 · 구현 · 측정 · 양면 · 검토 · 반영 · 보류 · 바로잡음
...
사건들 = ["등록", "승인", "구현", "측정", "양면", "검토", "반영", "보류", "바로잡음"]


def 적기(사건: str, 제안: str, **나머지) -> dict:
    한줄 = {"때": datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "사건": 사건, "제안": 제안}
...
def main() -> int:
    ...
    한줄 = 적기(args.사건, args.제안, 내용=args.내용, 규칙=args.규칙,
